...
test('Verify that user can create an article', async ({
    mainPage,
    createArticlePage,
    articleDetailsPage,
}) => {
    ...
    await expect(articleDetailsPage.articleTitle).toContainText(
        articleData.title,
    );
    await expect(articleDetailsPage.articleContent).toContainText(
        articleData.content,
    );
    ...
    await expect(createdArticle.description).toContainText(
        articleData.description,
    );
});
