...
export class CreateArticlePage{
    ...
    constructor(page: Page){
        ...
        this.articleContentInput = page.getByRole('textbox',{name:"Write your article (in markdown)"})
        this.articleTagInput = page.getByRole('textbox',{name:"Enter tags"})
        this.publishButton = page.getByRole('button', {name: ' Publish Article '})
    };

    async createArticle(title: string, description: string, content: string, tags: string){
